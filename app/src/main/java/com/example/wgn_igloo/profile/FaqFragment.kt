...
class FaqFragment : Fragment() {
    ...
    private var faqList: List<FaqItem> = listOf(
        ...
        FaqItem("How do you manage the items in your fridge?", "You can manage items in your fridge by clicking the item you want to manage, when you do this the item's details will show and from their you can either edit, delete, or add your items to your shopping list."),
        ...
        FaqItem("How does the shopping list feature work?", "Users are able to add items to their shopping list for when they go grocery shopping. Once the user buys the items in their shopping list, they can easily add it to their inventory by clicking the check box. Users can either add items to their shopping list using the input form or by clicking the add to shopping list button from their inventory."),
